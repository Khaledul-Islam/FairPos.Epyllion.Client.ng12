...
@Component({
  selector: 'app-arrival-report',
  templateUrl: './arrival-report.component.html',
  styleUrls: ['./arrival-report.component.scss'],
})
export class ArrivalReportComponent implements OnInit {
  ...
  reportButtonClick() {
    ...
    if (this.summary == true) {
      var url_ = this.env.reportUrl + 'Arrival/ArrivalSummary?FromDate=' + this.fromDate + '&Todate=' + this.toDate + '&ProductId=' + this.prdID + '&ItemId=' + this.itmID + '&SupId=' + this.supID + '&SecretKey=' + this.env.secrectKey;
      window.open(url_, '_blank')?.focus();
      this.calcelButtonClick();
    }
    if (this.summary == false) {
      var url_ = this.env.reportUrl + 'Arrival/ArrivalDetails?FromDate=' + this.fromDate + '&Todate=' + this.toDate + '&ProductId=' + this.prdID + '&ItemId=' + this.itmID + '&SupId=' + this.supID + '&SecretKey=' + this.env.secrectKey;
      window.open(url_, '_blank')?.focus();
      this.calcelButtonClick();
    }
