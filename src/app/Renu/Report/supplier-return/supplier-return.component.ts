...
export class SupplierReturnComponent implements OnInit {
  ...
  reportButtonClick() {
    ...
    if (this.summary == true) {
      var url_ = 
      this.env.reportUrl + 'Transfer/TransferSummary?FromDate=' + 
      this.fromDate + '&Todate=' + this.toDate + '&ShopId=' + 
      this.ShopId + '&ProductId=' + this.prdID + '&ItemId=' + 
      this.itmID + '&SupId=' + this.supID + '&StockType=' + 
      this.stockType + '&SecretKey=' + this.env.secrectKey;
      window.open(url_, '_blank')?.focus();
      this.calcelButtonClick();
    }
    if (this.summary == false) {
      var url_ = 
      this.env.reportUrl + 'Transfer/TransferDetails?FromDate=' + 
      this.fromDate + '&Todate=' + this.toDate + '&ShopId=' + 
      this.ShopId + '&ProductId=' + this.prdID + '&ItemId=' + 
      this.itmID + '&SupId=' + this.supID + '&StockType=' + 
      this.stockType + '&SecretKey=' + this.env.secrectKey;
