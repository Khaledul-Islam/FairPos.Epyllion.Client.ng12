...
export class QCReportComponent implements OnInit {
  ...
  reportButtonClick() {
    ...
    if (this.summary == true) {
      var url_ = this.env.reportUrl + 'Receive/ReceiveSummary?FromDate=' + this.fromDate + '&Todate=' + this.toDate + '&ProductId=' + this.prdID + '&ItemId=' + this.itmID + '&SupId=' + this.supID + '&SecretKey=' + this.env.secrectKey;
      window.open(url_, '_blank')?.focus();
      this.calcelButtonClick();
    }
    if (this.summary == false) {
      var url_ = this.env.reportUrl + 'Receive/ReceiveDetails?FromDate=' + this.fromDate + '&Todate=' + this.toDate + '&ProductId=' + this.prdID + '&ItemId=' + this.itmID + '&SupId=' + this.supID + '&SecretKey=' + this.env.secrectKey;
      window.open(url_, '_blank')?.focus();
      this.calcelButtonClick();
    }
