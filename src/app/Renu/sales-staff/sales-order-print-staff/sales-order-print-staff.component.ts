...
import { VerifyItemStaffComponent } from './verify-item-staff/verify-item-staff.component';

@Component({
  selector: 'app-sales-order-print-staff',
  templateUrl: './sales-order-print-staff.component.html',
  styleUrls: ['./sales-order-print-staff.component.scss'],
})
export class SalesOrderPrintStaffComponent implements OnInit {
  ...
  dtElement: any;
  @ViewChild(VerifyItemStaffComponent) childItemComponent: any;
  ...
  async GetPendingSalesOrder() {
    let promise = this.http.get(this.env.apiUrl + 'SalesOrderPrint/PendingSalesOrderStaff').toPromise();
