...
@Component({
  selector: 'app-staff-to-main-worker',
  templateUrl: './staff-to-main-worker.component.html',
  styleUrls: ['./staff-to-main-worker.component.scss'],
})
export class StaffToMainWorkerComponent implements OnInit {
  ...
  public APIURL = {
    parent: 'StaffToMainWorker/GetMainWorkerProducts',
    child: 'StaffToMainWorker/GetMainWorkerNewBarcode',
    details: 'StaffToMainWorker/GetMainWorkerBarcodeExp',
  };
  ...
  async GetTransferBarcodeExp(Barcode: any) {
    let promise = this.http
      .get(this.env.apiUrl + 'StaffToMainWorker/GetMainWorkerBarcodeExp?expbarcode=' + Barcode)
      .toPromise();
  ...
  async SaveTempStockTransfer() {
    ...
    let promise = this.http
      .post(this.env.apiUrl + 'StaffToMainWorker/SaveTempStockTransfer', this.buyDetails)
      .toPromise();
    return promise
      .then((res) => {
        this.rerender();
  ...
  async saveButtonClick() {
    ...
    this.alertService.confirm('are you sure you want to Save this data', () => {
      let promise = this.http
        .post(this.env.apiUrl + 'StaffToMainWorker/SaveStockTransfer', this.TempStockTransferList, {
          responseType: 'text',
        })
        .toPromise();
      return promise
  ...
  LoadDataTable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        dataTablesParameters.search.vendorno = 'Staff Stock';
        that.http
          .post<DataTablesResponse>(this.env.apiUrl + 'StaffToMainWorker/GetTempDataTable', dataTablesParameters, {})
          .subscribe((resp) => {
