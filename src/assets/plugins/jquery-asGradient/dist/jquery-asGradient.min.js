  ...
  var c = {
    ...
    d = {
      ...
      parsePosition: function (t) {
        return (
          'string' == typeof t && '%' === t.substr(-1) && (t = parseFloat(t.slice(0, -1) / 100)),
      ...
      parseAngle: function (t, e) {
        if (
          ('string' == typeof t && t.includes('deg') && (t = t.replace('deg', '')),
    ...
    b = (function () {
      function t(e, n) {
        o(this, t),
          'object' === (void 0 === e ? 'undefined' : p(e)) && void 0 === n && ((n = e), (e = void 0)),
        ...
        f(
          ...
          [
            ...
            },
            {
              key: 'type',
              value: function (t) {
                return 'string' == typeof t && (t = t.toUpperCase()) && void 0 !== m[t]
                  ? ((this._type = t), this)
                  : this._type;
              },
            },
            {
              ...
              value: function (t) {
                ...
                n &&
                  ...
                  this.type(n.type),
                  n.value &&
                    ((this.value.angle = d.parseAngle(n.value.angle, null !== this._prefix)),
