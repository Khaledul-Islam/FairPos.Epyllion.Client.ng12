    ...
    (function (factory) {
            ...
            if (regexMask) {
              if (element.indexOf('[') === 0 || (escaped && /\\d|\\s|\\w]/i.test(element)) || element === '.') {
                ...
                $.each(element.split(''), function (ndx, lmnt) {
                  ...
                  mtoken.matches.splice(position++, 0, {
                    ...
                    optionality: false,
                    newBlockMarker:
                      prevMatch === undefined ? 'master' : prevMatch.def !== lmnt && prevMatch.fn !== null,
                    casing: null,
              ...
              if (maskdef && !escaped) {
                ...
                mtoken.matches.splice(position++, 0, {
                  ...
                  optionality: false,
                  newBlockMarker:
                    prevMatch === undefined ? 'master' : prevMatch.def !== element && prevMatch.fn !== null,
                  casing: null,
          ...
          function verifyGroupMarker(maskToken) {
            if (maskToken && maskToken.matches) {
              $.each(maskToken.matches, function (ndx, token) {
                ...
                if (
                  (nextToken === undefined || nextToken.matches === undefined || nextToken.isQuantifier === false) &&
                  token &&
                  token.isGroup
                ) {
                  token.isGroup = false;
      ...
      function maskScope(actionObj, maskset, opts) {
                        ...
                        for (var ndx2 = 0; ndx2 < malternateMatches.length; ndx2++) {
                          ...
                          if (
                            ...
                            (altMatch.alternation !== undefined &&
                              $.inArray(altMatch.locator[altMatch.alternation].toString(), altIndexArr) !== -1)
                          ) {
          ...
          if (alternation !== undefined) {
            ...
            while (getMaskSet().excludes[decisionPos] && getMaskSet().excludes[decisionPos].length < 10) {
              ...
              while (validInputs.length > 0) {
                ...
                if (
                  !(isValidRslt = isValid(getLastValidPosition(undefined, true) + 1, input, false, fromSetValid, true))
                ) {
                  break;
                }
              }
        ...
        function revalidateMask(pos, validTest, fromSetValid, validatedPos) {
          ...
          if (
            begin !== end ||
            (opts.insertMode && getMaskSet().validPositions[validatedPos] !== undefined && fromSetValid === undefined)
          ) {
                ...
                for (var i = 0; i < tests.length; i++) {
                  if (
                    ...
                    (tests[i].match.fn === null ||
                      prevTest === undefined ||
                      tests[i].match.fn.test(prevTest.match.def, getMaskSet(), pos, true, opts) !== false)
                  ) {
              ...
              do {
                if (getMaskSet().validPositions[pos]) {
                  ...
                  if (
                    ...
                    pos < lvp ||
                    (typeof opts.jitMasking === 'number' && isFinite(opts.jitMasking) && opts.jitMasking > pos)
                  ) {
                ...
                ((maxLength === undefined || pos < maxLength) && (test.fn !== null || test.def !== '')) ||
                lvp > pos ||
                isStatic
              );
        ...
        function mask(elem) {
          function isElementTypeSupported(input, opts) {
                    ...
                    get: function get(elem) {
                      if (elem.inputmask) {
                        if (elem.inputmask.opts.autoUnmask) {
                          ...
                          return getLastValidPosition(undefined, undefined, elem.inputmask.maskset.validPositions) !==
            ...
            var isSupported =
              (input.tagName === 'INPUT' && $.inArray(elementType, opts.supportsInputType) !== -1) ||
          ...
          if (isSupported !== false) {
            ...
            if (
              ...
              var initialValue = $.isFunction(opts.onBeforeMask)
                ? opts.onBeforeMask.call(inputmask, el.inputmask._valueGet(true), opts) || el.inputmask._valueGet(true)
                : el.inputmask._valueGet(true);
        ...
        numeric: {
          ...
          postValidation: function postValidation(buffer, pos, currentResult, opts) {
            ...
            if (charAtPos !== undefined) {
              if (
                ...
                if (
                  ...
                  caretPos >= maskedValue.length - opts.suffix.length - (opts.isNegative === false ? 1 : 0)
                ) {
            ...
            if (processValue !== '') {
              ...
              if (
                (!opts.digitsOptional || (opts.enforceDigitsOnBlur && currentResult.event === 'blur')) &&
            ...
            var rslt = {
              caret:
                (charAtPos === undefined || currentResult.pos !== undefined) && caretPos !== undefined
