  ...
  function maskScope(actionObj, maskset, opts) {
    ...
    function getMaskTemplate(baseOnInput, minimalPos, includeMode, noJit, clearOptionalTail) {
      ...
      do {
        if (baseOnInput === true && getMaskSet().validPositions[pos]) {
          ...
          maskTemplate.push(
            includeMode === true ? testPos.input : includeMode === false ? test.nativeDef : getPlaceholder(pos, test)
          );
        } else {
    ...
    function revalidateMask(pos, validTest, fromSetValid, validatedPos) {
      function IsEnclosedStatic(pos, valids, selection) {
        ...
        if (
          posMatch !== undefined &&
          ((posMatch.match.fn === null && posMatch.match.optionality !== true) || posMatch.input === opts.radixPoint)
        ) {
          var prevMatch =
    ...
    var EventHandlers = {
      ...
      pasteEvent: function (e) {
        ...
        if (
          ...
          valueBeforeCaret = '';
        if (
          valueAfterCaret === (isRTL ? getBufferTemplate().reverse() : getBufferTemplate()).slice(caretPos.end).join('')
        )
          valueAfterCaret = '';
                ...
                get: function (elem) {
                  if (elem.inputmask) {
                    if (elem.inputmask.opts.autoUnmask) {
                      ...
                      return getLastValidPosition(undefined, undefined, elem.inputmask.maskset.validPositions) !== -1 ||
                        opts.nullable !== true
                        ? result
                        : '';
                    }
