!(function (a, b, c, d) {
  ...
  (g.prototype.init = function (b) {
    ...
    (g.prototype.destroy = function () {
      this.initialized &&
        (this.$wrapper.remove(), (this.$wrapper = null), this.unsubscribeEvents(), (this.initialized = !1));
    }),
    ...
    (g.prototype.clickHandler = function (b) {
      ...
      if (d && !d.state.disabled) {
        ...
        -1 !== e.indexOf('expand-icon')
          ...
          : (d.selectable ? this.toggleSelectedState(d, f.options) : this.toggleExpandedState(d, f.options),
            this.render());
      }
    }),
        ...
        a.each(b, function (b, e) {
          ...
          if (
            ...
            h.push(e.icon || d.options.nodeIcon),
              e.state.selected &&
                (h.pop(), h.push(e.selectedIcon || d.options.selectedIcon || e.icon || d.options.nodeIcon)),
              f.append(a(d.template.icon).addClass(h.join(' ')));
          }
    ...
    (g.prototype.buildStyle = function () {
      ...
      return (
        ...
        this.options.showBorder
          ? this.options.borderColor && (a += 'border:1px solid ' + this.options.borderColor + ';')
          : (a += 'border:none;'),
        (a += '}'),
