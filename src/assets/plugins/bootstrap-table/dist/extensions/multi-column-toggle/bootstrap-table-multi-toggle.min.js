...
!(function (a) {
  ...
  a.extend(a.fn.bootstrapTable.defaults, { showToggleBtn: !1, multiToggleDefaults: [] }),
    ...
    if (
      ...
      b.append(c + d),
        b.find('#showAllBtn').click(function () {
          a.showAllColumns(), b.find('#hideAllBtn').toggleClass('hidden'), b.find('#showAllBtn').toggleClass('hidden');
        }),
        b.find('#hideAllBtn').click(function () {
          a.hideAllColumns(), b.find('#hideAllBtn').toggleClass('hidden'), b.find('#showAllBtn').toggleClass('hidden');
        });
    }
  }),
