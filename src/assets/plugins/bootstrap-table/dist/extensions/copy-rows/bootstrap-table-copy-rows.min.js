...
!(function (a) {
  ...
  a.extend(a.fn.bootstrapTable.defaults, { copyBtn: !1, copyWHiddenBtn: !1, copyDelemeter: ', ' }),
    a.fn.bootstrapTable.methods.push('copyColumnsToClipboard', 'copyColumnsToClipboardWithHidden');
      ...
      a.each(d.getSelections(), function (c, g) {
        a.each(d.options.columns[0], function (a, h) {
          'state' !== h.field &&
            'RowNumber' !== h.field &&
            h.visible &&
            (null !== g[h.field] && (e += b(h, d.header.formatters[a], [g[h.field], g, c], g[h.field])), (e += f));
        }),
          (e += '\r\n');
      }),
        c(e);
