...
!(function (a) {
  ...
  (c.prototype.init = function () {
    ...
    (c.prototype.onDrop = function (b, c) {
      for (
        var d = a(b), e = d.data('bootstrap.table'), f = d.data('bootstrap.table').options, g = null, h = [], i = 0;
        i < b.tBodies[0].rows.length;
        i++
      )
        (g = a(b.tBodies[0].rows[i])), h.push(f.data[g.data('index')]), g.data('index', i).attr('data-index', i);
      (f.data = f.data
