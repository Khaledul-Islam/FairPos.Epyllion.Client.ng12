...
!(function (a) {
  ...
  var b,
    ...
    f = void 0,
    g = function (b, c) {
      for (var d = b.$body.find('tr').not('[data-tt-parent-id]'), e = 0; e < d.length; e++)
    ...
    i = function (a, g) {
      return (
        b.apply([a, g]),
        (e[c.toString()] = g),
        a.IsParent ? ((f = g), delete e[d.toString()]) : (e[d.toString()] = void 0 === f ? g : f),
        e
      );
    },
    j = function (a, b) {
    ...
    k = function (a, b, c) {
      for (var d = {}, e = 0; e < a.options.groupByField.length; e++)
        d[a.options.groupByField[e].toString()] = b[c][0][a.options.groupByField[e]];
    ...
    m = function (b, c) {
      for (
        ...
        f[g].unshift(k(b, f, g)), b.options.groupBySumGroup && ((e = h(b, f[g])), a.isEmptyObject(e) || f[g].push(e));
      return (
        (d = d.concat.apply(d, f)),
        !b.options.loaded &&
          d.length > 0 &&
          ((b.options.loaded = !0), (b.options.originalData = b.options.data), (b.options.data = d)),
        d
      );
    };
  a.extend(a.fn.bootstrapTable.defaults, {
    ...
    a.fn.bootstrapTable.methods.push('collapseAll', 'expandAll', 'refreshGroupByField'),
          ...
          c.$el.treetable(
            ...
            void 0 !== c.options.groupByInitExpanded &&
              ('number' == typeof c.options.groupByInitExpanded
                ...
                : 'all' === c.options.groupByInitExpanded.toLowerCase() && c.expandAll());
        });
    }
        ...
        (this.options.groupBy &&
          ...
          ((this.options.groupByField =
            'string' == typeof this.options.groupByField
              ? this.options.groupByField.replace('[', '').replace(']', '').replace(/ /g, '').toLowerCase().split(',')
              : this.options.groupByField),
