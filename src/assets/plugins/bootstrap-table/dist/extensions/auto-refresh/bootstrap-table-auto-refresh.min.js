...
!(function (a) {
  ...
  a.extend(a.fn.bootstrapTable.defaults, {
    ...
    a.extend(a.fn.bootstrapTable.defaults.icons, { autoRefresh: 'glyphicon-time icon-time' }),
  ...
  (b.prototype.init = function () {
    ...
    (b.prototype.initToolbar = function () {
      if ((d.apply(this, Array.prototype.slice.apply(arguments)), this.options.autoRefresh)) {
        var b = this.$toolbar.find('>.btn-group'),
          c = b.find('.auto-refresh');
        c.length ||
          ((c = a(
            [
              e('<button class="btn btn-default auto-refresh %s" ', this.options.autoRefreshStatus ? 'enabled' : ''),
              'type="button" ',
              e('title="%s">', this.options.formatAutoRefresh()),
              e('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.autoRefresh),
              '</button>',
            ].join('')
          ).appendTo(b)),
