...
!(function (a) {
  ...
  a.extend(a.fn.bootstrapTable.defaults, {
    ...
    onTreeFormatter: function (a) {
      for (
        var b = this, c = b.options, d = a._level || 0, e = (a._parent && a._parent._level) || 0, f = [], g = 0;
        e > g;
        g++
      )
        f.push('<i class="' + c.treeVerticalcls + '"></i>'), f.push('<i class="' + c.treeSpacecls + '"></i>');
      for (var g = e; d > g; g++)
        f.push(
          a._last && g === d - 1
    ...
    c &&
      a.each(this.header.fields, function (a, d) {
        if (c === d) {
          ...
          return (
            b.header.classes[a] && f.push(b.header.classes[a].split('"')[1] || ''),
            ...
            (b.header.formatters[a] = function (a, c) {
              ...
              return (
                ...
                d.push(e ? e.apply(this, Array.prototype.slice.apply(arguments)) : a),
                d.push('</span>'),
                d.join('')
              );
            }),
  ...
  var e = function (b, d, f, g) {
    ...
    for (var j = i.length - 1, k = 0; j >= k; k++) {
      var l = i[k];
      (l._level = b._level + 1), (l._parent = b), k === j && (l._last = 1), e.apply(h, [l, a.inArray(l, f), f, g]);
    }
  };
