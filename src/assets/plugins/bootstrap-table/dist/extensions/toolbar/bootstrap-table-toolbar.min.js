...
!(function (a) {
  ...
  var b = !1,
    ...
    e = function (a, b, d) {
      ...
      return (
        ...
        e.push(
          c('<button type="button" id="btnCloseAvd%s" class="btn btn-default" >%s</button>', '_' + d.options.idTable, b)
        ),
        e.push('</div>'),
        e.push('</div>'),
        e.push('</form>'),
  ...
  a.extend(a.fn.bootstrapTable.defaults, {
    ...
    a.extend(a.fn.bootstrapTable.defaults.icons, { advancedSearchIcon: 'glyphicon-chevron-down' }),
    a.extend(a.fn.bootstrapTable.Constructor.EVENTS, { 'column-advanced-search.bs.table': 'onColumnAdvancedSearch' }),
  ...
  (f.prototype.initToolbar = function () {
    if (
      ...
      this.options.search && this.options.advancedSearch && this.options.idTable)
    ) {
      var a = this,
        b = [];
      b.push(
    ...
    (f.prototype.load = function () {
      if (
        ...
        this.options.advancedSearch && 'undefined' != typeof this.options.idTable && !b)
      ) {
