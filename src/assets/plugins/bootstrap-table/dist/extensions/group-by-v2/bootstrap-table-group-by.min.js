        ...
        this.columns.forEach(function (a) {
          ...
          c.forEach(function (b) {
            ...
            c.push(d('<tr class="info groupBy expanded" data-group-index="%s">', b.id)),
              e.options.detailView && !e.options.cardView && c.push('<td class="detail"></td>'),
              f && c.push('<td class="bs-checkbox">', '<input name="btSelectGroup" type="checkbox" />', '</td>'),
              c.push('<td', d(' colspan="%s"', g), '>', b.name, '</td>'),
              c.push('</tr>'),
              e.$body.find('tr[data-parent-index=' + b.id + ']:first').before(a(c.join('')));
          }),
          (this.$selectGroup = []),
          ...
          this.$container.off('click', '.groupBy').on('click', '.groupBy', function () {
            a(this).toggleClass('expanded'),
              e.$body
                .find('tr[data-parent-index=' + a(this).closest('tr').data('group-index') + ']')
                .toggleClass('hidden');
          }),
