...
!(function (a) {
  ...
  var b = {
    ...
    g = function (a, b, c) {
      if (a.options.cookie && e() && '' !== a.options.cookieIdTable && -1 !== f(b, a.options.cookiesEnabled)) {
        switch (((b = a.options.cookieIdTable + '.' + b), a.options.cookieStorage)) {
          case 'cookieStorage':
            document.cookie = [
              b,
              '=',
  ...
  (l.prototype.init = function () {
    if (
      ...
      (this.options.cookiesEnabled =
        'string' == typeof this.options.cookiesEnabled
          ? this.options.cookiesEnabled.replace('[', '').replace(']', '').replace(/ /g, '').toLowerCase().split(',')
          : this.options.cookiesEnabled),
    ...
    (l.prototype.initServer = function () {
      var a = this;
      if (a.options.cookie && a.options.filterControl && !a.options.filterControlValuesLoaded) {
    ...
    (l.prototype.initCookie = function () {
      if (this.options.cookie) {
        if ('' === this.options.cookieIdTable || '' === this.options.cookieExpire || !e())
          return (
            console.error(
        ...
        (this.options.sortOrder = c ? c : this.options.sortOrder),
          ...
          (this.options.pageSize = g ? (g === this.options.formatAllRows() ? g : +g) : this.options.pageSize),
    ...
    (l.prototype.onPageNumber = function () {
      return q.apply(this, Array.prototype.slice.apply(arguments)), g(this, b.pageNumber, this.options.pageNumber), !1;
    }),
    ...
    (l.prototype.onPagePre = function () {
      return s.apply(this, Array.prototype.slice.apply(arguments)), g(this, b.pageNumber, this.options.pageNumber), !1;
    }),
    (l.prototype.onPageNext = function () {
      return t.apply(this, Array.prototype.slice.apply(arguments)), g(this, b.pageNumber, this.options.pageNumber), !1;
    }),
    ...
    (l.prototype.selectPage = function (a) {
      v.apply(this, Array.prototype.slice.apply(arguments)), g(this, b.pageNumber, a);
    }),
    (l.prototype.onSearch = function () {
      var c = Array.prototype.slice.apply(arguments);
      w.apply(this, c),
        a(c[0].currentTarget).parent().hasClass('search') && g(this, b.searchText, this.searchText),
        g(this, b.pageNumber, this.options.pageNumber);
    }),
    (l.prototype.getCookies = function () {
      ...
      return (
        a.each(b, function (a, b) {
          (d[a] = h(c, c.options.cookieIdTable, b)), 'columns' === a && (d[a] = JSON.parse(d[a]));
        }),
        d
      );
    }),
