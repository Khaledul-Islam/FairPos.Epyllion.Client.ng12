      ...
      if (!g.length) {
        g = a(
          [
            ...
            b('<i class="%s %s"></i> ', this.options.iconsPrefix, this.options.icons['export']),
        ...
        a.each(i, function (a, b) {
          c.hasOwnProperty(b) &&
            h.append(
              [
                '<li role="menuitem" class="dropdown-item" data-type="' + b + '">',
          ...
          h.find('li').click(function () {
            ...
            if ('all' === d.options.exportDataType && d.options.pagination)
              d.$el.one(
                'server' === d.options.sidePagination ? 'post-body.bs.table' : 'page-change.bs.table',
                function () {
