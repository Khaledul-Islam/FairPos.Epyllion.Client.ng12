          ...
          (this.data = c
            ? a.grep(this.data, function (d, f) {
                for (var g in d) {
                  ...
                  i &&
                    i.searchFormatter &&
                    (h = a.fn.bootstrapTable.utils.calculateObjectValue(i, b.header.formatters[j], [h, d, f], h));
                  var k = a.inArray(g, b.header.fields);
                  if (-1 !== k && b.header.searchables[k] && ('string' == typeof h || 'number' == typeof h))
                    if ((b.options.searchAccentNeutralise && ((h = e(h)), (c = e(c))), b.options.strictSearch)) {
