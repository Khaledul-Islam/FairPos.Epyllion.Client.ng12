...
!(function (a) {
  ...
  var b = a.fn.bootstrapTable.utils.sprintf,
    ...
    f = function (b, c, d) {
      (c = a.trim(c)),
        ...
        h(b, c) || b.append(a('<option></option>').attr('value', c).text(a('<div />').html(d).text()));
    },
    g = function (b) {
      b = a(b.get(b.length - 1));
      ...
      c.sort(function (b, c) {
        return (
          ...
          a.isNumeric(b) && a.isNumeric(c) && ((b = parseFloat(b)), (c = parseFloat(c))),
          b > c ? 1 : c > b ? -1 : 0
        );
      }),
    ...
    h = function (a, b) {
      for (var c = d(a), e = 0; e < c.length; e++) if (c[e].value === b.toString()) return !0;
      return !1;
    },
    i = function (a) {
    ...
    q = function (b) {
      var c = b.data,
        ...
        j = b.options.pagination ? ('server' === b.options.sidePagination ? b.pageTo : b.options.totalRows) : b.pageTo;
      a.each(b.header.fields, function (k, l) {
        ...
        if (d(m) && h(m) && i(n)) {
          ...
          for (var o = {}, p = 0; j > p; p++) {
            var q = c[p][l],
              s = a.fn.bootstrapTable.utils.calculateObjectValue(b.header, b.header.formatters[k], [q, c[p], p], q);
            o[s] = q;
          }
      ...
      a.each(c.columns, function (b, j) {
        if (((e = 'hidden'), (h = []), j.visible)) {
          ...
          if (
            ...
            (l = j.filterData.substring(j.filterData.indexOf(':') + 1, j.filterData.length)),
            ...
            d.find('.date-filter-control').length > 0 &&
              a.each(c.columns, function (c, e) {
                void 0 !== e.filterControl &&
                  ...
                  d
                    .find('.date-filter-control.bootstrap-table-filter-control-' + e.field)
  ...
  a.extend(a.fn.bootstrapTable.defaults, {
    ...
    a.extend(a.fn.bootstrapTable.defaults.icons, { clear: 'glyphicon-trash icon-clear' }),
  ...
  (w.prototype.init = function () {
    ...
    (w.prototype.initToolbar = function () {
      if (
        ...
        d.length ||
          ((d = a(
            [
              b('<button class="btn btn-%s filter-show-clear" ', this.options.buttonsClass),
              b('type="button" title="%s">', this.options.formatClearFilters()),
              b('<i class="%s %s"></i> ', this.options.iconsPrefix, this.options.icons.clear),
              '</button>',
            ].join('')
          ).appendTo(c)),
    ...
    (w.prototype.initSearch = function () {
      if ((B.apply(this, Array.prototype.slice.apply(arguments)), 'server' !== this.options.sidePagination)) {
        var b = this,
          c = a.isEmptyObject(b.filterColumnsPartial) ? null : b.filterColumnsPartial;
        b.data = c
          ? a.grep(b.data, function (d, e) {
              for (var f in c) {
                ...
                if (
                  ...
                  -1 !== a.inArray(f, b.header.fields) && ('string' == typeof i || 'number' == typeof i))
                )
    ...
    (w.prototype.clearFilterControl = function () {
      if (this.options.filterControl && this.options.filterShowClear) {
        ...
        if (
          ...
          c.options.sortName !== f.data('sortName') || c.options.sortOrder !== f.data('sortOrder'))
        ) {
          var l = e.find(b('[data-field="%s"]', a(g[0]).closest('table').data('sortName')));
          l.length > 0 && (c.onSort(f.data('sortName'), f.data('sortName')), a(l).find('.sortable').trigger('click'));
        }
        clearTimeout(i),
