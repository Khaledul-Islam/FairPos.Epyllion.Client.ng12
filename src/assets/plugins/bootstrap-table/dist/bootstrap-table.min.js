  ...
  (q.DEFAULTS = {
          ...
          a.each(d, function (d, e) {
            (e = a.extend({}, q.COLUMN_DEFAULTS, e)),
              'undefined' != typeof e.fieldIndex &&
                ((b.columns[e.fieldIndex] = e), (b.fieldsColumnsIndex[e.field] = e.fieldIndex)),
        ...
        a.each(this.options.columns, function (e, g) {
          d.push('<tr>'),
            0 === e &&
              ...
              d.push(f('<th class="detail" rowspan="%s"><div class="fht-cell"></div></th>', b.options.columns.length)),
            a.each(g, function (a, e) {
              ...
              if (
                (void 0 === e.width ||
                  b.options.cardView ||
                  ('string' == typeof e.width && -1 !== e.width.indexOf('%') && (m = '%')),
                e.width && 'string' == typeof e.width && (n = e.width.replace('%', '').replace('px', '')),
                (h = f('text-align: %s; ', e.halign ? e.halign : e.align)),
                (i = f('text-align: %s; ', e.align)),
                (j = f('vertical-align: %s; ', e.valign)),
                (j += f(
                  'width: %s; ',
                  (!e.checkbox && !e.radio) || n ? (n ? n + m : void 0) : e.showSelectTitle ? void 0 : '36px'
                )),
                'undefined' != typeof e.fieldIndex)
              ) {
                if (
              ...
              d.push(
                ...
                e.checkbox || e.radio ? f(' class="bs-checkbox %s"', e['class'] || '') : k,
                f(' style="%s"', h + j),
              ...
              return void 0 !== k
                ...
                : ((void 0 === h || null === h) && (h = ''),
                  ...
                  b.options.sortStable && h === i
                    ? ((h = f._position), (i = g._position), f._position - g._position)
                    : a.isNumeric(h) && a.isNumeric(i)
                    ? ((h = parseFloat(h)), (i = parseFloat(i)), i > h ? -1 * d : d)
                    : h === i
                    ? 0
                    : ('string' != typeof h && (h = h.toString()), -1 === h.localeCompare(i) ? -1 * d : d));
            }),
    ...
    (q.prototype.initToolbar = function () {
      ...
      this.$toolbar.find('.bs-bars').children().length && a('body').append(a(this.options.toolbar)),
        ...
        ('string' == typeof this.options.toolbar || 'object' == typeof this.options.toolbar) &&
          a(f('<div class="bs-bars %s-%s"></div>', d.pullClass, this.options.toolbarAlign))
        ...
        this.options.showPaginationSwitch &&
          g.push(
            ...
            f('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.paginationSwitchDown),
            '</button>'
          ),
        ...
        this.options.showRefresh &&
          g.push(
            ...
            f('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.refresh),
            '</button>'
          ),
        this.options.showToggle &&
          g.push(
            ...
            f('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.toggleOff),
            '</button>'
          ),
        this.options.showFullscreen &&
          g.push(
            ...
            f('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.fullscreen),
            '</button>'
          ),
        this.options.showColumns &&
          (g.push(
            f('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()),
            '<button type="button" aria-label="columns" class="btn' +
              f(' btn-%s', this.options.buttonsClass) +
              f(' btn-%s', this.options.iconSize) +
              ' dropdown-toggle" data-toggle="dropdown">',
            f('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.columns),
              ...
              b.switchable &&
                (g.push(
                  f(
                    ...
                    f('<input type="checkbox" data-field="%s" value="%s"%s> %s', b.field, a, c, b.title)
                  )
                ),
                i++);
            }
        ...
        this.options.search &&
          ((g = []),
          g.push(
            f('<div class="%s-%s search">', d.pullClass, this.options.searchAlign),
            f(
              '<input class="form-control' + f(' input-%s', this.options.iconSize) + '" type="text" placeholder="%s">',
    ...
    (q.prototype.initSearch = function () {
      ...
      if ('server' !== this.options.sidePagination) {
        if (this.options.customSearch !== a.noop)
          return void window[this.options.customSearch].apply(this, [this.searchText]);
    ...
    (q.prototype.initPagination = function () {
      ...
      if (
        ...
        l.push(
          f('<div class="%s-%s pagination-detail">', d.pullClass, this.options.paginationDetailHAlign),
        ...
        var q = [
          f(
            ...
            'top' === this.options.paginationVAlign || 'both' === this.options.paginationVAlign ? 'dropdown' : 'dropup'
          ),
        ...
        if ('string' == typeof this.options.pageList) {
          ...
          (o = []),
            a.each(r, function (a, b) {
              o.push(
                b.toUpperCase() === k.options.formatAllRows().toUpperCase() || 'UNLIMITED' === b.toUpperCase()
        ...
        for (
          a.each(o, function (a, b) {
            ...
            l.push(
              '</div>',
              f('<div class="%s-%s pagination">', d.pullClass, this.options.paginationHAlign),
              '<ul class="pagination' + f(' pagination-%s', this.options.iconSize) + '">',
              f(
            ...
            this.totalPages >= 6 &&
              (this.options.pageNumber >= 3 &&
                (l.push(
                  f('<li class="page-item page-first%s">', 1 === this.options.pageNumber ? ' active' : ''),
              ...
              this.options.pageNumber >= 4 &&
                ...
                e--)),
            this.totalPages >= 7 && this.options.pageNumber >= this.totalPages - 2 && c--,
            6 == this.totalPages
              ? this.options.pageNumber >= this.totalPages - 2 && e++
              : this.totalPages >= 7 && (7 == this.totalPages || this.options.pageNumber >= this.totalPages - 3) && e++,
            b = c;
          e >= b;
          b++
        )
          l.push(
            f('<li class="page-item%s">', b === this.options.pageNumber ? ' active' : ''),
            '<a class="page-link" href="#">',
            b,
            '</a>',
            '</li>'
        ...
        this.totalPages >= 8 &&
          ...
          this.totalPages >= 6 &&
            ...
            l.push(
              f('<li class="page-item page-last%s">', this.totalPages === this.options.pageNumber ? ' active' : ''),
              '<a class="page-link" href="#">',
              this.totalPages,
              '</a>',
              '</li>'
      ...
      this.$pagination.html(l.join('')),
        this.options.onlyInfoPagination ||
          ...
          (j = this.$pagination.find('.page-item').not('.page-next, .page-pre')),
          this.options.smartDisplay &&
            (this.totalPages <= 1 && this.$pagination.find('div.pagination').hide(),
            (o.length < 2 || this.options.totalRows <= o[0]) && this.$pagination.find('span.page-list').hide(),
    ...
    (q.prototype.onPageNumber = function (b) {
      return (
        ...
        this.options.pageNumber !== +a(b.currentTarget).text()
          ? ((this.options.pageNumber = +a(b.currentTarget).text()), this.updatePagination(b), !1)
          : void 0
      );
    }),
      ...
      if (!(a.inArray(b, this.hiddenRows) > -1)) {
        ...
        return (
          ...
          !this.options.cardView &&
            ...
            j(null, this.options.detailFilter, [c, b]) &&
              h.push(
                ...
                f('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.detailOpen),
                '</a>'
              ),
            h.push('</td>')),
          a.each(this.header.fields, function (d, m) {
            ...
            if (
              (!e.fromHtml || 'undefined' != typeof p || z.checkbox || z.radio) &&
              z.visible &&
              ...
              if (
                ...
                b['_' + m + '_class'] && (u = f(' class="%s"', b['_' + m + '_class'])),
                b['_' + m + '_rowspan'] && (w = f(' rowspan="%s"', b['_' + m + '_rowspan'])),
                b['_' + m + '_colspan'] && (x = f(' colspan="%s"', b['_' + m + '_colspan'])),
                b['_' + m + '_title'] && (y = f(' title="%s"', b['_' + m + '_title'])),
              ...
              (q = j(z, e.header.formatters[d], [p, b, c, m], p)),
                ...
                z.checkbox || z.radio
                  ? ((r = z.checkbox ? 'checkbox' : r),
                    ...
                    (o = [
                      f(
                        e.options.cardView ? '<div class="card-view %s">' : '<td class="bs-checkbox %s">',
                        z['class'] || ''
                      ),
                      '<input' +
                        f(' data-index="%s"', c) +
                        ...
                        f(' checked="%s"', q === !0 || p || (q && q.checked) ? 'checked' : void 0) +
                        f(' disabled="%s"', !z.checkboxEnabled || (q && q.disabled) ? 'disabled' : void 0) +
                        ' />',
                      e.header.formatters[d] && 'string' == typeof q ? q : '',
                      e.options.cardView ? '</div>' : '</td>',
                    ].join('')),
                    (b[e.header.stateField] = q === !0 || !!p || (q && q.checked)))
                  : ((q = 'undefined' == typeof q || null === q ? e.options.undefinedText : q),
                    (o = e.options.cardView
                      ? [
                          '<div class="card-view">',
                          e.options.showHeader
                            ? f('<span class="title" %s>%s</span>', i, g(e.columns, 'field', 'title', m))
                            : '',
                          f('<span class="value">%s</span>', q),
                          '</div>',
                        ].join('')
                      : [f('<td%s %s %s %s %s %s %s>', t, u, i, v, w, x, y), q, '</td>'].join('')),
                    e.options.cardView && e.options.smartDisplay && '' === q && (o = '<div class="card-view"></div>')),
                h.push(o);
            }
          }),
      ...
      e ||
        g.append(
          '<tr class="no-records-found">' +
            f('<td colspan="%s">%s</td>', this.$header.find('th').length, this.options.formatNoMatches()) +
            '</tr>'
        ),
        this.$body.html(g),
        b || this.scrollTo(0),
        this.$body
          ...
          .on('click dblclick', function (b) {
            ...
            if (
              ...
              (c.trigger('click' === b.type ? 'click-cell' : 'dbl-click-cell', j, l, g, d),
              c.trigger('click' === b.type ? 'click-row' : 'dbl-click-row', g, e, j),
              'click' === b.type &&
        ...
        this.$body
          ...
          .on('click', function (b) {
            ...
            if (g.next().is('tr.detail-view'))
              e.find('i').attr('class', f('%s %s', c.options.iconsPrefix, c.options.icons.detailOpen)),
    ...
    (q.prototype.initServer = function (b, c, d) {
      ...
      this.header.sortNames[h] && (i.sortName = this.header.sortNames[h]),
        this.options.pagination &&
          'server' === this.options.sidePagination &&
          ((i.pageSize =
            this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize),
        ...
        (d || this.options.url || this.options.ajax) &&
          ...
          g !== !1 &&
            ...
            (e = a.extend({}, j(null, this.options.ajaxOptions), {
              ...
              error: function (a) {
                ...
                'server' === f.options.sidePagination &&
                  ((c = {}), (c[f.options.totalField] = 0), (c[f.options.dataField] = [])),
                  f.load(c),
            ...
            this.options.ajax
              ...
              : (this._xhr && 4 !== this._xhr.readyState && this._xhr.abort(), (this._xhr = a.ajax(e)))));
    }),
    ...
    (q.prototype.fitHeader = function () {
      ...
      if (
        ...
        (c = b.scrollWidth > b.clientWidth && b.scrollHeight > b.clientHeight + this.$header.outerHeight() ? i() : 0),
      ...
      this.$body.find('>tr:first-child:not(.no-records-found) > *').each(function (b) {
        ...
        if (
          (g.options.detailView &&
            !g.options.cardView &&
            (0 === b && g.$header_.find('th.detail').find('.fht-cell').width(c.innerWidth()), (d = b - 1)),
          -1 !== d)
        ) {
    ...
    (q.prototype.resetFooter = function () {
      ...
      this.options.showFooter &&
        ...
        (!this.options.cardView &&
          this.options.detailView &&
          d.push('<td><div class="th-inner">&nbsp;</div><div class="fht-cell"></div></td>'),
    ...
    (q.prototype.load = function (b) {
      var c = !1;
      this.options.pagination && 'server' === this.options.sidePagination
        ? ((this.options.totalRows = b[this.options.totalField]), (c = b.fixedScroll), (b = b[this.options.dataField]))
      ...
      for (b = f - 1; b >= 0; b--) {
        ...
        if (
          ('string' == typeof d
            ? (a = a.toString())
            : 'number' == typeof d &&
              (Number(d) === d && d % 1 === 0 ? (a = parseInt(a)) : d === Number(d) && 0 !== d && (a = parseFloat(a))),
          d === a)
        ) {
          g = c;
          break;
    ...
    (q.prototype.updateByUniqueId = function (b) {
      ...
      a.each(d, function (b, d) {
        ...
        d.hasOwnProperty('id') &&
          ...
          ((e = a.inArray(c.getRowByUniqueId(d.id), c.options.data)), -1 !== e && a.extend(c.options.data[e], d.row));
      }),
        this.initSearch(),
        this.initPagination(),
        this.initSort(),
    ...
    (q.prototype.refreshColumnTitle = function (b) {
      if (
        ...
        ((this.columns[this.fieldsColumnsIndex[b.field]].title = this.options.escape ? l(b.title) : b.title),
    ...
    (q.prototype.toggleRow = function (b, c) {
      ...
      b.hasOwnProperty('index')
        ...
        d &&
          ...
          c || -1 !== e ? c && e > -1 && this.hiddenRows.splice(e, 1) : this.hiddenRows.push(d),
          this.initBody(!0));
    }),
    ...
    (q.prototype.updateCell = function (a) {
      a.hasOwnProperty('index') &&
        ...
        ((this.data[a.index][a.field] = a.value), a.reinit !== !1 && (this.initSort(), this.initBody(!0)));
    }),
    ...
    (q.prototype.toggleView = function () {
      ...
      this.options.cardView
        ? (a.removeClass(this.options.icons.toggleOff), a.addClass(this.options.icons.toggleOn))
        : (a.removeClass(this.options.icons.toggleOn), a.addClass(this.options.icons.toggleOff)),
        this.initBody(),
      ...
      if (b) {
        ...
        if (
          (c.next().is('tr.detail-view')
            ? c.next().next().is('tr.detail-view') || (c.next().find('.detail-icon').click(), (g = !0))
