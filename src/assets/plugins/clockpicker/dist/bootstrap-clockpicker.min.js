...
!(function () {
  ...
  function s(s, n) {
    ...
    if (
      ...
      c('<button type="button" class="btn btn-sm btn-default clockpicker-button am-button">AM</button>')
        .on('click', function () {
          (H.amOrPm = 'AM'), c('.clockpicker-span-am-pm').empty().append('AM');
        })
        .appendTo(this.amPmBlock),
        c('<button type="button" class="btn btn-sm btn-default clockpicker-button pm-button">PM</button>')
          .on('click', function () {
    ...
    n.autoclose ||
      c('<button type="button" class="btn btn-sm btn-default btn-block clockpicker-button">' + n.donetext + '</button>')
