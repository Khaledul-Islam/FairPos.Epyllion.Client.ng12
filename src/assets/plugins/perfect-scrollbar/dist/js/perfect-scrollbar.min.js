    ...
    1: [
      function (t, e, n) {
        ...
        'function' == typeof define && define.amd
          ? define(r)
          : ((window.PerfectScrollbar = r), 'undefined' == typeof window.Ps && (window.Ps = r));
      },
      { '../main': 7 },
    ],
    2: [
          ...
          function r() {
            c ||
              (c = setInterval(function () {
                return l.get(t)
                  ? (s(t, 'top', t.scrollTop + u.top), s(t, 'left', t.scrollLeft + u.left), void i(t))
      ...
      function (t, e, n) {
        ...
        function r(t) {
          ...
          (r.settings = s.clone(c)),
            ...
            (r.railXMarginWidth =
              s.toInt(u.css(r.scrollbarXRail, 'marginLeft')) + s.toInt(u.css(r.scrollbarXRail, 'marginRight'))),
            ...
            (r.railYMarginHeight =
              s.toInt(u.css(r.scrollbarYRail, 'marginTop')) + s.toInt(u.css(r.scrollbarYRail, 'marginBottom'))),
