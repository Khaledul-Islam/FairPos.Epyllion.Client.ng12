...
!(function (t, e) {
  ...
  var i = (function () {
    ...
    p = (function () {
      function t(e, t) {
        if (
          ...
          (this.options = $.extend(
            {},
            { title: '', target: t.container, trigger: 'hover focus', placement: 'bottom' },
            t
          )),
          (this.$tooltip = $(
            [
          ...
          this.options.trigger.split(' ').forEach(function (t) {
            'hover' === t
              ? (e.off('mouseenter mouseleave'), e.on('mouseenter', o).on('mouseleave', n))
              : 'click' === t
              ? e.on('click', i)
      ...
      return (
        (t.prototype.show = function () {
          ...
          'bottom' === i
            ...
            : 'right' === i && o.css({ top: e.top + (s / 2 - l / 2), left: e.left + r });
        }),
    ...
    o = (function () {
      function t(t, e) {
        (this.$button = t), (this.options = $.extend({}, { target: e.container }, e)), this.setEvent();
      }
      return (
  ...
  var n = (function () {
      ...
      return (
        (t.prototype.show = function () {
          'body' === this.options.target
            ? (this.$backdrop.css('position', 'fixed'), this.$modal.css('position', 'fixed'))
            : (this.$backdrop.css('position', 'absolute'), this.$modal.css('position', 'absolute')),
    ...
    f = t('<button type="button" class="note-btn" role="button" tabindex="-1">', function (t, e) {
      e &&
        ...
        t.data('_lite_tooltip', new p(t, { title: e.tooltip, container: e.container }))),
        e.contents && t.html(e.contents),
        e && e.data && 'dropdown' === e.data.toggle && t.data('_lite_dropdown', new o(t, { container: e.container }));
    }),
    ...
    v = t('<div class="note-color-palette"/>', function (t, e) {
      ...
      t.html(o.join('')),
        t.find('.note-color-btn').each(function () {
          $(this).data('_lite_tooltip', new p($(this), { container: e.container }));
        });
    }),
    ...
    C = t('<div class="checkbox"></div>', function (t, e) {
      t.html(
        [
          '<label' + (e.id ? ' for="' + e.id + '"' : '') + '>',
          ' <input role="checkbox" type="checkbox"' + (e.id ? ' id="' + e.id + '"' : ''),
          e.checked ? ' checked' : '',
    ...
    x = {
      ...
      dropdownButton: function (t, e) {
        return h(
          [
            ...
            m({ className: t.className, items: t.items, template: t.template, itemClick: t.itemClick }),
          ],
          { callback: e }
        ).render();
      },
          ...
          children: [
            ...
            m({
              items: [
                ...
                '  <div class="note-palette-title">' + c.lang.color.background + '</div>',
                '  <div>',
                ...
                '  <div class="note-palette-title">' + c.lang.color.foreground + '</div>',
                '  <div>',
              ...
              callback: function (t) {
                t.find('.note-holder').each(function () {
                  var t = $(this);
                  t.append(v({ colors: c.colors, eventName: t.data('event') }).render());
                }),
                  'fore' === d
                    ? (t.find('.btn-background-color').hide(), t.css({ 'min-width': '210px' }))
                    : 'back' === d && (t.find('.btn-foreground-color').hide(), t.css({ 'min-width': '210px' }));
              },
              click: function (t) {
                var e = $(t.target),
                  o = e.data('event'),
                ...
                if (
                  ('cp' === n ? t.stopPropagation() : 'cpbackColor' === n ? (n = r) : 'cpforeColor' === n && (n = i),
                  o && n)
                ) {
      ...
      videoDialog: function (t) {
        ...
        return b({ title: t.lang.video.insert, fade: t.fade, body: e, footer: o }).render();
      },
      imageDialog: function (t) {
        ...
        return b({ title: t.lang.image.insert, fade: t.fade, body: e, footer: o }).render();
      },
      linkDialog: function (t) {
        ...
        return b({ className: 'link-dialog', title: t.lang.link.insert, fade: t.fade, body: e, footer: o }).render();
      },
      popover: y,
      checkbox: C,
      icon: w,
      ...
      createLayout: function (t, e) {
        var o = (
          e.airMode
            ...
            : x.editor([x.toolbar(), x.editingArea([x.codable(), x.editable()]), x.statusbar()])
        ).render();
        return (
          o.insertAfter(t),
          {
  ...
  if (N) {
    ...
    E && (T = parseFloat(E[1])), (E = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(I)) && (T = parseFloat(E[1]));
  }
  var A = /Edge\/\d+/.test(I),
    F = !!window.CodeMirror;
  if (!F && S)
    if ('function' == typeof __webpack_require__)
      ...
      else void 0 !== require.specified && (F = require.specified('codemirror'));
  ...
  function Nt(t, e) {
    ...
    return (
      vt(s, mt(r)), o || (ht(t.node), ht(s)), i && (ut(t.node) && Ft(t.node), ut(s)) ? (Ft(s), t.node.nextSibling) : s
    );
  }
  function Et(t, o, n) {
    ...
    return e.length
      ? 1 === e.length
        ...
        : e.reduce(function (t, e) {
            return t === o.node && (t = Nt(o, n)), Nt({ node: e, offset: t ? xt(t) : dt(e) }, n);
          })
      : null;
  }
  function At(t) {
  ...
  var Lt = {
    ...
    splitPoint: function (t, e) {
      ...
      var a = o && Et(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
    ...
    replace: function (t, e) {
      ...
      var o = At(e);
      return t.style.cssText && (o.style.cssText = t.style.cssText), vt(o, j.from(t.childNodes)), gt(o, t), Ft(t), o;
    },
    html: function (t, e) {
      var o = Pt(t);
      e &&
  ...
  function Dt(t) {
    var s = function (t, e) {
        ...
        if (Lt.isText(t)) {
          ...
          (o = r || t.parentNode), (e += j.sum(j.tail(i), Lt.nodeLength)), (n = !r);
        } else {
  ...
  var Bt = (function () {
      ...
      return (
        (r.prototype.nativeRange = function () {
          ...
          return e.setEndPoint('EndToEnd', Dt({ node: this.ec, offset: this.eo })), e;
        }),
        ...
        (r.prototype.scrollIntoView = function (t) {
          var e = k(t).height();
          return (
            t.scrollTop + e < this.sc.offsetTop && (t.scrollTop += Math.abs(t.scrollTop + e - this.sc.offsetTop)), this
          );
        }),
        (r.prototype.normalize = function () {
          var t = function (t, e) {
              if (
                ...
                (Lt.isVisiblePoint(t) && Lt.isBlock(t.node) && Lt.isEmpty(t.node))
              )
                return t;
              var o = Lt.ancestor(t.node, Lt.isBlock);
              if (
                ((Lt.isLeftEdgePointOf(t, o) || Lt.isVoid(Lt.prevPoint(t).node)) && !e) ||
                ((Lt.isRightEdgePointOf(t, o) || Lt.isVoid(Lt.nextPoint(t).node)) && e)
              ) {
                ...
                Lt.isEditable(t.node) ||
                  (i
                    ? (Lt.isLeftEdgePoint(t) && a.push(t.node),
                      Lt.isRightEdgePoint(t) && j.contains(a, t.node) && (e = t.node))
        ...
        (r.prototype.expand = function (t) {
          ...
          return (
            e && ((n.sc = e), (n.so = 0)), o && ((n.ec = o), (n.eo = Lt.nodeLength(o))), new r(n.sc, n.so, n.ec, n.eo)
          );
        }),
        ...
        (r.prototype.splitText = function () {
          var t = this.sc === this.ec,
            e = this.getPoints();
          return (
            Lt.isText(this.ec) && !Lt.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo),
            Lt.isText(this.sc) &&
        ...
        (r.prototype.wrapBodyInlineWithPara = function () {
          if (Lt.isBodyContainer(this.sc) && Lt.isEmpty(this.sc))
            return (this.sc.innerHTML = Lt.emptyPara), new r(this.sc.firstChild, 0, this.sc.firstChild, 0);
          var t,
            e = this.normalize();
          if (Lt.isParaInline(this.sc) || Lt.isPara(this.sc)) return e;
          if (Lt.isInline(e.sc)) {
            var o = Lt.listAncestor(e.sc, D.not(Lt.isInline));
            (t = j.last(o)), Lt.isInline(t) || (t = o[o.length - 2] || e.sc.childNodes[e.so]);
        ...
        (r.prototype.paraBookmark = function (t) {
          return {
            s: { path: j.tail(Lt.makeOffsetPath(j.head(t), this.sc)), offset: this.so },
            e: { path: j.tail(Lt.makeOffsetPath(j.last(t), this.ec)), offset: this.eo },
          };
        }),
  ...
  var Mt = (function () {
      ...
      return (
        ...
        (t.prototype.toggleList = function (o, t) {
          ...
          if (j.find(i, Lt.isPurePara)) {
            ...
            var l = e.nodes(Lt.isList, { includeAncestor: !0 }).filter(function (t) {
    ...
    jt = (function () {
      ...
      return (
        (t.prototype.insertTab = function (t, e) {
          ...
          (t = t.deleteContents()).insertNode(o, !0), (t = zt.create(o, e)).select();
        }),
          ...
          if (n) {
            ...
            if (
              (1 === this.options.blockquoteBreakingLevel
                ...
                : 2 === this.options.blockquoteBreakingLevel && (i = Lt.lastAncestor(n, Lt.isBlockquote)),
              i)
            ) {
              (o = k(Lt.emptyPara)[0]),
                Lt.isRightEdgePoint(e.getStartPoint()) && Lt.isBR(e.sc.nextSibling) && k(e.sc.nextSibling).remove();
              var r = Lt.splitTree(i, e.getStartPoint(), { isDiscardEmptySplits: !0 });
            ...
            (o = k(Lt.emptyPara)[0]), a ? e.sc.insertBefore(o, a) : e.sc.appendChild(o);
          }
    ...
    qt = function (t, h, p, i) {
      ...
      (this.getActionList = function () {
        for (
          var t, e, o, n = h === qt.where.Row ? f.rowPos : -1, i = h === qt.where.Column ? f.colPos : -1, r = 0, s = !0;
          s;
  ...
  (qt.where = { Row: 0, Column: 1 }),
    ...
    (qt.resultAction = { Ignore: 0, SubtractSpanCount: 1, RemoveCell: 2, AddCell: 3, SumSpanCount: 4 });
  var Kt,
    Vt = (function () {
      function t() {}
      return (
        ...
        (t.prototype.addRow = function (t, e) {
          for (
            var o = Lt.ancestor(t.commonAncestor(), Lt.isCell),
              ...
              r = k('<tr' + i + '></tr>'),
              s = new qt(o, qt.where.Row, qt.requestAction.Add, k(n).closest('table')[0]).getActionList(),
              a = 0;
            a < s.length;
            a++
          ) {
              ...
              case qt.resultAction.SumSpanCount:
                if ('top' === e)
                  if ((l.baseCell.parent ? l.baseCell.closest('tr').rowIndex : 0) <= n[0].rowIndex) {
                    var d = k('<div></div>')
                      .append(k('<td' + c + '>' + Lt.blank + '</td>').removeAttr('rowspan'))
                      .html();
                    r.append(d);
                    break;
                  }
        ...
        (t.prototype.addCol = function (t, e) {
          ...
          k(n).siblings().push(n);
          for (
            var i = new qt(o, qt.where.Column, qt.requestAction.Add, k(n).closest('table')[0]).getActionList(), r = 0;
            r < i.length;
            r++
          ) {
            var s = i[r],
        ...
        (t.prototype.deleteRow = function (t) {
          for (
            var e = Lt.ancestor(t.commonAncestor(), Lt.isCell),
              ...
              i = o[0].rowIndex,
              r = new qt(e, qt.where.Row, qt.requestAction.Delete, k(o).closest('table')[0]).getActionList(),
              s = 0;
            s < r.length;
            s++
          )
                ...
                case qt.resultAction.SubtractSpanCount:
                  c &&
                    (2 < d
                      ...
                      : 2 === d &&
                        (a.removeAttribute('rowSpan'), l.rowIndex !== i && a.cellIndex === n && (a.innerHTML = '')));
                  continue;
        ...
        (t.prototype.deleteCol = function (t) {
          for (
            var e = Lt.ancestor(t.commonAncestor(), Lt.isCell),
              o = k(e).closest('tr'),
              n = o.children('td, th').index(k(e)),
              i = new qt(e, qt.where.Column, qt.requestAction.Delete, k(o).closest('table')[0]).getActionList(),
              r = 0;
            r < i.length;
            r++
          )
              ...
              switch (i[r].action) {
                ...
                case qt.resultAction.SubtractSpanCount:
                  ...
                  if (s.colSpan && 1 < s.colSpan) {
                    ...
                    2 < a
                      ? (a--, s.setAttribute('colSpan', a), s.cellIndex === n && (s.innerHTML = ''))
                      : 2 === a && (s.removeAttribute('colSpan'), s.cellIndex === n && (s.innerHTML = ''));
                  }
                  continue;
                case qt.resultAction.RemoveCell:
    ...
    Wt = (function () {
            ...
            if (!(0 < r && u.isLimited(r))) {
              ...
              'string' == typeof o && (o = o.trim()),
                u.options.onCreateLink
                  ...
                  : /^\.?\/(.*)/.test(o) || (o = /^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(o) ? o : 'http://' + o);
              var a = [];
              if (s) {
      ...
      return (
        (t.prototype.initialize = function () {
          ...
          this.$editable
            .on('keydown', function (t) {
              if (
                (t.keyCode === K.code.ENTER && e.context.triggerEvent('enter', t),
        ...
        (t.prototype.getSelectedText = function () {
          var t = this.createRange();
          return t.isOnAnchor() && (t = zt.createFromNode(Lt.ancestor(t.sc, Lt.isAnchor))), t.toString();
        }),
  ...
  var Yt = (function () {
      ...
      return (
        ...
        (t.prototype.activate = function () {
          var e = this;
          if (
            (this.$codable.val(Lt.html(this.$editable, this.options.prettifyHtml)),
        ...
        (t.prototype.isFontInstalled = function (t) {
          return (
            this.fontInstalledMap.hasOwnProperty(t) ||
              (this.fontInstalledMap[t] = L.isFontInstalled(t) || j.contains(this.options.fontNamesIgnoreCheck, t)),
            ...
            return n.ui
              .buttonGroup([
                ...
                n.ui.dropdown({
                  ...
                  template: function (t) {
                    'string' == typeof t &&
                      (t = { tag: t, title: n.lang.style.hasOwnProperty(t) ? n.lang.style[t] : t });
                    var e = t.tag,
                      o = t.title;
                    return (
                      '<' +
              ...
              c.ui.onDialogShown(c.$dialog, function () {
                ...
                a.prop('checked', o),
                  s.one('click', function (t) {
                    t.preventDefault(),
                      n.resolve({ range: l.range, url: r.val(), text: i.val(), isNewWindow: a.is(':checked') }),
        ...
        (t.prototype.createShortcutList = function () {
          ...
          return Object.keys(i)
            .map(function (t) {
              ...
              return (
                o
                  .append(k('<label><kbd>' + t + '</kdb></label>').css({ width: 180, 'margin-right': 10 }))
        ...
        (t.prototype.handleKeydown = function (t) {
          this.$popover.is(':visible') &&
            (t.keyCode === K.code.ENTER
              ...
              : t.keyCode === K.code.DOWN && (t.preventDefault(), this.moveDown()));
        }),
