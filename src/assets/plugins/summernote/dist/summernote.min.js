...
!(function (t, e) {
  ...
  var i = (function () {
    ...
    p = o('<div class="note-color-palette"/>', function (t, e) {
      ...
      t.html(o.join('')),
        e.tooltip &&
          t.find('.note-color-btn').tooltip({ container: e.container, trigger: 'hover', placement: 'bottom' });
    }),
  ...
  function wt(t, e) {
    ...
    return (
      ut(s, ct(r)), o || (st(t.node), st(s)), i && (rt(t.node) && Tt(t.node), rt(s)) ? (Tt(s), t.node.nextSibling) : s
    );
  }
  function xt(t, o, n) {
  ...
  var Rt = (function () {
      ...
      return (
        ...
        (r.prototype.expand = function (t) {
          ...
          return (
            e && ((n.sc = e), (n.so = 0)), o && ((n.ec = o), (n.eo = Nt.nodeLength(o))), new r(n.sc, n.so, n.ec, n.eo)
          );
        }),
  ...
  var Ht = (function () {
          ...
          if (n) {
            ...
            if (
              (1 === this.options.blockquoteBreakingLevel
                ...
                : 2 === this.options.blockquoteBreakingLevel && (i = Nt.lastAncestor(n, Nt.isBlockquote)),
              i)
            ) {
              (o = k(Nt.emptyPara)[0]),
    ...
    Mt = function (t, h, p, i) {
      ...
      (this.getActionList = function () {
        for (
          var t, e, o, n = h === Mt.where.Row ? f.rowPos : -1, i = h === Mt.where.Column ? f.colPos : -1, r = 0, s = !0;
          s;
    ...
    Ut = (function () {
      ...
      return (
        ...
        (t.prototype.addCol = function (t, e) {
          ...
          k(n).siblings().push(n);
          for (
            var i = new Mt(o, Mt.where.Column, Mt.requestAction.Add, k(n).closest('table')[0]).getActionList(), r = 0;
            r < i.length;
            r++
          ) {
            var s = i[r],
        ...
        (t.prototype.isFontInstalled = function (t) {
          return (
            this.fontInstalledMap.hasOwnProperty(t) ||
              (this.fontInstalledMap[t] = z.isFontInstalled(t) || N.contains(this.options.fontNamesIgnoreCheck, t)),
