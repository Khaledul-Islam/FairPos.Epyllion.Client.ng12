  ...
  return {
    ...
    supported: function () {
      var a = this.USER_AGENT.toLowerCase(),
        ...
        a =
          (this.isIos() && 5 > ((/ipad|iphone|ipod/.test(a) && a.match(/ os (\d+).+? like mac os x/)) || [, 0])[1]) ||
    ...
    _onLoadIframe: function (f) {
      if (b.dom.contains(c.documentElement, f)) {
        var g = this,
          ...
          k = this._getHtml({ charset: c.characterSet || c.charset || 'utf-8', stylesheets: this.config.stylesheets });
...
(function (b) {
  ...
  b.Selection = Base.extend({
    ...
    _selectLine_MSIE: function () {
      ...
      if (a.moveToPoint) {
        0 === b &&
          ((f = this.doc.createElement('span')), this.insertNode(f), (b = f.offsetTop), f.parentNode.removeChild(f));
        b += 1;
        for (f = -10; f < c; f += 2)
          try {
            a.moveToPoint(f, b);
  ...
  f.prototype = {
    ...
    undoToRange: function (a) {
      ...
      1 == g
        ...
        : (a.setStart(c[0], 0), (d = c[c.length - 1]), a.setEnd(d, d.length), this.normalize && this.postApply(c, a));
    },
        ...
        ? a.selection.executeAndRestore(function () {
            for (var a = h.length, b = 0, c, d, f; b < a; b++)
              (c = h[b]),
                ...
                f.match(e.autoLink.URL_REG_EXP) && !d ? e.renameElement(c, 'code') : e.replaceWithChildNodes(c);
          })
...
(function (b) {
  ...
  b.toolbar.Toolbar = Base.extend({
    ...
    _getLinks: function (a) {
      for (
        var c = (this[a + 'Links'] = b.lang.array(this.container.querySelectorAll('[data-wysihtml5-' + a + ']')).get()),
          e = c.length,
          f = 0,
          g = (this[a + 'Mapping'] = {}),
          i,
