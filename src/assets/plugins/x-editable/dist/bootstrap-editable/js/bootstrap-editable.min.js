...
!(function (a) {
        ...
        a
          ...
          .done(
            a.proxy(function (a) {
              this.isSaving = !1;
              var b =
                'function' == typeof this.options.success ? this.options.success.call(this.options.scope, a, c) : null;
              return b === !1
    ...
    save: function (b) {
      ...
      var c,
        ...
        e = !!(
          ...
          (this.options.url &&
            ('always' === this.options.send || ('auto' === this.options.send && null !== d && void 0 !== d)))
        );
      return e
        ? (this.showLoading(),
      ...
      createInput: function (b) {
        ...
        return (
          ...
          'function' == typeof a.fn.editabletypes[f]
            ? ((c = a.fn.editabletypes[f]), (d = this.sliceObj(b, this.objectKeys(c.defaults))), (e = new c(d)))
      ...
      save: function (a, b) {
        if (this.options.unsavedclass) {
          ...
          (c = c || 'function' == typeof this.options.url),
            ...
            (c =
              c ||
              (this.options.savenochange && this.input.value2str(this.value) !== this.input.value2str(b.newValue))),
            c
            ...
            for (var h = 0; h < b.length; h++)
              (e = b[h]),
                'object' == typeof e
                  ? ((c = 0),
                    a.each(e, f),
                    1 === c ? g.push(d) : c > 1 && (e.children && (e.children = this.makeArray(e.children)), g.push(e)))
        ...
        function c(b, c) {
          ...
          return (
            b.children('option').each(function (b, e) {
              ...
              '' !== g &&
                ((f = Math.abs(g - c)),
                ('undefined' == typeof d.distance || f < d.distance) && (d = { value: g, distance: f }));
            }),
            d.value
          );
        }
  ...
  (function (a) {
    ...
    a.extend(a.fn.editableContainer.Popup.prototype, {
      ...
      innerCss:
        a.fn.popover && a(a.fn.popover.defaults.template).find('p').length ? '.popover-content p' : '.popover-content',
      ...
      setPosition: function () {
        !function () {
          ...
          switch (
            ...
            (b = /in/.test(f)),
            l.removeClass('top right bottom left').css({ top: 0, left: 0, display: 'block' }),
      ...
      fill: function () {
        ...
        for (var p, q = []; m.valueOf() < o; ) {
          ...
          void 0 === v
            ...
            (p = a.unique(p)),
            q.push(
              '<td class="' + p.join(' ') + '"' + (c ? ' title="' + c + '"' : '') + '>' + m.getUTCDate() + '</td>'
            ),
          ...
          case 39:
            ...
            (b = 37 == a.keyCode ? -1 : 1),
              ...
              this.dateWithinRange(c) &&
                ((this.date = c), (this.viewDate = d), this.setValue(), this.update(), a.preventDefault(), (e = !0));
            break;
          case 38:
          case 40:
            if (!this.o.keyboardNavigation) break;
      ...
      h = (a.fn.datepicker = function (b) {
        ...
        return (
          this.each(function () {
            ...
            return 'string' == typeof b && 'function' == typeof k[b] && ((h = k[b].apply(k, g)), void 0 !== h)
              ? !1
              : void 0;
          }),
          void 0 !== h ? h : this
        ...
        parseDate: function (a, b) {
          ...
          return (
            a &&
              ...
              'string' == typeof a &&
                ((c = this.dpg.formatDate(d, b, this.options.datepicker.language)), a !== c && (d = null))),
            d
          );
        },
      }),
        ...
        parseDate: function (a, b) {
          ...
          return (
            a &&
              ...
              'string' == typeof a &&
                ((c = this.dpg.formatDate(d, b, this.options.datetimepicker.language, this.options.formatType)),
                a !== c && (d = null))),
            d
          );
        },
    ...
    var b = function (c) {
      this.init('typeahead', c, b.defaults),
        (this.options.typeahead = a.extend(
          ...
          { matcher: this.matcher, sorter: this.sorter, highlighter: this.highlighter, updater: this.updater },
          c.typeahead
        ));
    };
    a.fn.editableutils.inherit(b, a.fn.editabletypes.list),
