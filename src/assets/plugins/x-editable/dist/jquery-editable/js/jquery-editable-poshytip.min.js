    ...
    if (
      (a.extend(a.fn.editableContainer.Popup.prototype, {
        ...
        initContainer: function () {
          this.handlePlacement(),
            a.extend(this.containerOptions, { showOn: 'none', content: '', alignTo: 'target' }),
            this.call(this.containerOptions);
        },
        show: function (b) {
          this.$element.addClass('editable-open'),
      ...
      a.Poshytip.prototype.refresh = function (e) {
        if (!this.disabled) {
          ...
          h &&
            !a.support.opacity &&
            (d && c.test(h[1]) && ((h = !1), this.$arrow.css('background-image', 'none')), (this.opts.fade = !1));
          ...
          if (d) {
            ...
            !isNaN(l) && l > k ? (k = l) : !isNaN(m) && k > m && (k = m),
  ...
  (function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        ...
        autosubmit: function () {
          (this.isAutosubmit = !0),
            this.$input.on('mouseup', 'table.ui-datepicker-calendar a.ui-state-default', a.proxy(this.submit, this));
        },
        submit: function () {
