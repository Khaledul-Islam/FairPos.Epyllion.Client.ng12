        ...
        (function (t) {
          if ((lt(), t.type))
            if ((dt(), -1 !== Object.keys(g).indexOf(t.type))) {
              ...
              k(
                'Unknown type! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.type, '"')
              );
        })(t),
        (function (t) {
          var e = W();
          ...
          if (e) {
            if (
              ('string' == typeof t.backdrop
                ...
                : t.backdrop || E([document.documentElement, document.body], x['no-backdrop']),
              !t.backdrop &&
                t.allowOutsideClick &&
                C('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
              t.position in x
                ? E(e, x[t.position])
                : (C('The "position" parameter is not valid, defaulting to "center"'), E(e, x.center)),
    ...
    if (n) {
      ...
      var s = function () {
        et()
          ...
          : (new Promise(function (t) {
              ...
              (vt.restoreFocusTimeout = setTimeout(function () {
                vt.previousActiveElement && vt.previousActiveElement.focus
                  ? (vt.previousActiveElement.focus(), (vt.previousActiveElement = null))
          ...
          tt() &&
            (null !== v.previousBodyPadding &&
              ((document.body.style.paddingRight = v.previousBodyPadding + 'px'), (v.previousBodyPadding = null)),
            (function () {
                ...
                return (function (t, e) {
                  if ((e.stopKeydownPropagation && t.stopPropagation(), 'Enter' !== t.key || t.isComposing))
                    if ('Tab' === t.key) {
                      ...
                      -1 !==
                      ['ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'Left', 'Right', 'Up', 'Down'].indexOf(t.key)
