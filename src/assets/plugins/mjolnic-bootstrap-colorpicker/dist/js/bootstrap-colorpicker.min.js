!(function (a) {
  ...
  var b = function (b, c) {
    (this.value = { h: 0, s: 0, b: 0, a: 1 }),
      ...
      b && (void 0 !== b.toLowerCase ? ((b += ''), this.setColor(b)) : void 0 !== b.h && (this.value = b));
  };
  b.prototype = {
    constructor: b,
    colors: {
      ...
      return (
        a.each(this.stringParsers, function (a, f) {
          var g = f.re.exec(b),
            ...
            i = c || f.format || 'rgba';
          return h
            ? ((e = i.match(/hsla?/) ? d.RGBtoHSB.apply(d, d.HSLtoRGB.apply(d, h)) : d.RGBtoHSB.apply(d, h)),
              (d.origFormat = i),
              !1)
            : !0;
        }),
    ...
    toHex: function (a, b, c, d) {
      ...
      return this.rgbaIsTransparent(e)
        ? 'transparent'
        : '#' + ((1 << 24) | (parseInt(e.r) << 16) | (parseInt(e.g) << 8) | parseInt(e.b)).toString(16).substr(1);
    },
    ...
    toString: function (a) {
      ...
      switch (a) {
        case 'rgb':
          return (
            (b = this.toRGB()), this.rgbaIsTransparent(b) ? 'transparent' : 'rgb(' + b.r + ',' + b.g + ',' + b.b + ')'
          );
        case 'rgba':
        ...
        case 'hsl':
          return (
            (b = this.toHSL()),
            'hsl(' + Math.round(360 * b.h) + ',' + Math.round(100 * b.s) + '%,' + Math.round(100 * b.l) + '%)'
          );
        case 'hsla':
          return (
            (b = this.toHSL()),
