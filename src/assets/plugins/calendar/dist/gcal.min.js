...
!(function (e) {
  ...
  function a(a, t, d, c, i) {
    function s(o, r) {
      var l = r || [{ message: o }];
      (a.googleCalendarError || e.noop).apply(i, l),
        (i.options.googleCalendarError || e.noop).apply(i, l),
        n.warn.apply(null, [o].concat(r || []));
    }
    var u,
      g,
  ...
  n.sourceNormalizers.push(function (e) {
    ...
    !o &&
      ...
      (/^[^\/]+@([^\/\.]+\.)*(google|googlemail|gmail)\.com$/.test(r)
        ? (o = r)
        : ((a = /^https:\/\/www.googleapis.com\/calendar\/v3\/calendars\/([^\/]*)/.exec(r)) ||
            (a = /^https?:\/\/www.google.com\/calendar\/feeds\/([^\/]*)/.exec(r))) &&
